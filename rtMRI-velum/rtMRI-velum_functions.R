...
m1_null <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors_null,
  file = "./rtMRI-velum/rtMRI-velum/models/dur_null",
  save_all_pars = TRUE
)
...
m2 <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors,
  file = "./rtMRI-velum/rtMRI-velum/models/offset",
  save_all_pars = TRUE
)
...
m2_null <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors_null,
  file = "./rtMRI-velum/rtMRI-velum/models/offset_null",
  save_all_pars = TRUE
)
...
m3 <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors,
  file = "./rtMRI-velum/rtMRI-velum/models/onset",
  save_all_pars = TRUE
)
...
m3_null <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors_null,
  file = "./rtMRI-velum/rtMRI-velum/models/onset_null",
  save_all_pars = TRUE
)
...
m4 <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors,
  file = "./rtMRI-velum/rtMRI-velum/models/gest_max",
  save_all_pars = TRUE
)
...
m4_null <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors_null,
  file = "./rtMRI-velum/rtMRI-velum/models/gest_max_null",
  save_all_pars = TRUE
)
...
m5 <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors,
  file = "./rtMRI-velum/rtMRI-velum/models/gest_max_mag",
  save_all_pars = TRUE
)
...
m5_null <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors_null,
  file = "./rtMRI-velum/rtMRI-velum/models/gest_max_mag_null",
  save_all_pars = TRUE
)
...
m6 <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors,
  file = "./rtMRI-velum/rtMRI-velum/models/rate_v_nasal",
  save_all_pars = TRUE
)
...
m6_null <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors_null,
  file = "./rtMRI-velum/rtMRI-velum/models/rate_v_nasal_null",
  save_all_pars = TRUE
)
...
m7 <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors,
  file = "./rtMRI-velum/rtMRI-velum/models/rate_n_nasal",
  save_all_pars = TRUE
)
...
m7_null <- brms::brm(
  ...
  control = list(adapt_delta = 0.99,
                 max_treedepth = 20),
  prior = priors_null,
  file = "./rtMRI-velum/rtMRI-velum/models/rate_n_nasal_null",
  save_all_pars = TRUE
)
